...
{
    public class FixQuestTaskCompletionEventMigration
    {

        public static void Run(GameContext context)
        {
            FixQuestTaskCompletionEvent(context);
        }

        public static void FixQuestTaskCompletionEvent(GameContext context)
        {
