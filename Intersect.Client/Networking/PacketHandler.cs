...
namespace Intersect.Client.Networking
{
    ...
    internal sealed partial class PacketHandler
    {
        ...
        public void HandlePacket(IPacketSender packetSender, MapItemsPacket packet)
        {
            ...
            {
                var mapItem = new MapItemInstance(item.TileIndex,item.Id, item.ItemId, item.BagId, item.Quantity,item.ItemPropertiesJson);
        ...
        public void HandlePacket(IPacketSender packetSender, MapItemUpdatePacket packet)
        {
            ...
            else
            {
                ...
                var mapItem = new MapItemInstance(packet.TileIndex, packet.Id, packet.ItemId, packet.BagId, packet.Quantity, packet.ItemPropertiesJson);
        ...
        public void HandlePacket(IPacketSender packetSender, InventoryUpdatePacket packet)
        {
            if (Globals.Me != null)
            {
                Globals.Me.Inventory[packet.Slot].Load(packet.ItemId, packet.Quantity, packet.BagId, packet.ItemPropertiesJson);
        ...
        public void HandlePacket(IPacketSender packetSender, BankUpdatePacket packet)
        {
            ...
            if (packet.ItemId != Guid.Empty)
            {
                ...
                Globals.Bank[slot].Load(packet.ItemId, packet.Quantity, packet.BagId, packet.ItemPropertiesJson);
            }
            else
            {
        ...
        public void HandlePacket(IPacketSender packetSender, TradeUpdatePacket packet)
        {
            ...
            else
            {
                ...
                Globals.Trade[side, slot].Load(packet.ItemId, packet.Quantity, packet.BagId, packet.ItemPropertiesJson);
            }
        }
        ...
        public void HandlePacket(IPacketSender packetSender, BagUpdatePacket packet)
        {
            ...
            else
            {
                ...
                Globals.Bag[packet.Slot].Load(packet.ItemId, packet.Quantity, packet.BagId, packet.ItemPropertiesJson);
            }
        }
