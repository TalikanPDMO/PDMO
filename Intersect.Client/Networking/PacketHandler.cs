...
namespace Intersect.Client.Networking
{
    ...
    internal sealed partial class PacketHandler
    {
        ...
        public void HandlePacket(IPacketSender packetSender, InventoryUpdatePacket packet)
        {
            if (Globals.Me != null)
            {
                Globals.Me.Inventory[packet.Slot].Load(packet.ItemId, packet.Quantity, packet.BagId, packet.StatBuffs, packet.InvTab);
        ...
        public void HandlePacket(IPacketSender packetSender, BankUpdatePacket packet)
        {
            ...
            if (packet.ItemId != Guid.Empty)
            {
                ...
                Globals.Bank[slot].Load(packet.ItemId, packet.Quantity, packet.BagId, packet.StatBuffs, packet.InvTab);
            }
            else
            {
        ...
        public void HandlePacket(IPacketSender packetSender, TradeUpdatePacket packet)
        {
            ...
            else
            {
                ...
                Globals.Trade[side, slot].Load(packet.ItemId, packet.Quantity, packet.BagId, packet.StatBuffs, packet.InvTab);
            }
        }
        ...
        public void HandlePacket(IPacketSender packetSender, BagUpdatePacket packet)
        {
            ...
            else
            {
                ...
                Globals.Bag[packet.Slot].Load(packet.ItemId, packet.Quantity, packet.BagId, packet.StatBuffs, packet.InvTab);
            }
        }
        ...
        public void HandlePacket(IPacketSender packetSender, CharactersPacket packet)
        {
            ...
            {
                characters.Add(
                    new Character(chr.Id, chr.Name, chr.Sprite, chr.Face, chr.Level, chr.ClassName, chr.Equipment, chr.ElementalTypes)
                );
            }
